package edu.isi.bmkeg.kefed.services.extKefed
{
	...
	public interface IExtendedKefedService {
		...
		function retrieveCompleteKefedModelFromUuid(uid:String):void;
		
		function deleteCompleteKefedModel(id:Number):void;

		function deleteCompleteKefedModelFromUid(uid:String):void;
