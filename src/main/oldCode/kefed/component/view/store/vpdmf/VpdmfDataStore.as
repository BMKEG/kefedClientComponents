// $Id: PersevereDataStore.as 38 2011-03-18 05:41:28Z taruss2000@gmail.com $
...
package edu.isi.bmkeg.kefed.component.view.store.vpdmf
{
	 ...
	 * 
	 */	
	 public class VpdmfDataStore extends EventDispatcher implements IDataStore {
		 ...
		 */		
		 public function VpdmfDataStore(url:String)
		{
		 ...
		 */
		 public function listData():void {
			 var e:TriggerListKefedDataEvent = new TriggerListKefedDataEvent(0,100,"", true);
			 dispatchEvent( e );					
		}
		...
		public function retrieveData(uid:String):void {
			var e:TriggerRetrieveKefedDataEvent = new TriggerRetrieveKefedDataEvent(uid, true);
			dispatchEvent( e );					
		}
		 ...
		 */
		 public function insertData(experiment:KefedExperiment):void {
			 ...
			 var e:TriggerInsertKefedDataEvent = new TriggerInsertKefedDataEvent(experiment, true);
			 dispatchEvent( e );					
		}
		...
		public function saveData(experiment:KefedExperiment):void {
			experiment.updateTime();
			var e:TriggerSaveKefedDataEvent = new TriggerSaveKefedDataEvent(experiment, true);
			dispatchEvent( e );
		}
		...
		public function deleteData(uid:String):void	{
			var e:TriggerDeleteKefedDataEvent = new TriggerDeleteKefedDataEvent(uid, true);
			dispatchEvent( e );
		}
