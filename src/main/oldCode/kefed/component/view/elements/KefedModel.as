...
package edu.isi.bmkeg.kefed.component.view.elements
{
	...
	public class KefedModel extends Data {
		...
		public function createEdge(sourceUid:String, targetUid:String, linkUid:String):String
		{
			
			var source:KefedObject = this.getKefedObjectFromUID(sourceUid);
			var target:KefedObject = this.getKefedObjectFromUID(targetUid);
			
			var link:KefedLink = new KefedLink(linkUid, source, target, true);
